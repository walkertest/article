...
# 感受
- openclaw的使用过程中，还是存在不少的卡点；
- 对于浏览器或者本地文件的一些操作，还是有不少的卡点
- 比较适合用作个人的处理（数据分析、内容生成等）
- 和云端AI助手（比如豆包、千问）的区别在于，能够操作某台电脑的内容、比较私密
- 通用助手和垂直类的一些ai比起来，就是效果没有那么好，比如写代码.
- 当前体验下来，还是有不少的卡点或者效果不如预期，比如生成的ppt格式有问题，
